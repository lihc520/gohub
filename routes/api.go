...
import (
	...
	controllers "github.com/lihc520/gohub/app/http/controllers/api/v1"
	"github.com/lihc520/gohub/app/http/controllers/api/v1/auth"
	"github.com/lihc520/gohub/app/http/middlewares"
...
func RegisterAPIRoutes(r *gin.Engine) {
	...
	// 全局限流中间件：每小时限流。这里是所有 API（根据IP）请求加起来
